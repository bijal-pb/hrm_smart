...
Route::group(["namespace" => 'Front', 'middleware' => 'auth.employees', 'prefix' => 'panel'], function () {
    ...
    Route::post('/profile_detail_model', ['as' => 'front.profile_detail_model', 'uses' => 'DashboardController@profiledetailmodel']);
    ...
    //employee tasks front
    Route::get('ajax_employee_tasks/', ['as' => 'front.ajax_employee_tasks', 'uses' => 'EmployeeTaskFrontController@ajax_employee_tasks']);
    Route::resource('employee_tasks', 'EmployeeTaskFrontController', ['as' => 'front']);

    //assigned projects
    Route::get('ajax_assign_projects/', ['as' => 'front.ajax_assign_projects', 'uses' => 'AssignProjectController@ajax_assign_projects']);
    Route::resource('assign_projects', 'AssignProjectController', ['as' => 'front']);
    ...
    Route::get('front/attendance', ['uses' => 'DashboardController@index', 'as' => 'front.employeeDashboard']);
    Route::post('front/clock_in', ['uses' => 'DashboardController@clockIn', 'as' => 'front.attendance.clockIn']);
    Route::post('front/clock_out', ['uses' => 'DashboardController@clockOut', 'as' => 'front.attendance.clockOut']);
    Route::post('front/work_from', ['uses' => 'DashboardController@updateWorkFrom', 'as' => 'front.attendance.work_from']);
    Route::post('front/notes', ['uses' => 'DashboardController@updateNote', 'as' => 'front.attendance.notes']);
...
Route::group(["namespace" => 'Admin', 'middleware' => ['auth.admin', 'auth.screenlock', 'plan.null'], 'prefix' => 'admin'], function () {
    ...
    Route::post('attendances/ajax_load_employee', ['as' => 'admin.attendance.ajax_load_employee', 'uses' => 'AdminDashboardController@ajax_load_employee']);
    Route::post('attendances/ajax_update_employee_assign', ['as' => 'admin.project.update_employee_assign', 'uses' => 'AdminDashboardController@update_employee_assign']);
    ...
    // project routes
    Route::get('ajax_projects/', ['as' => 'admin.ajax_projects', 'uses' => 'ProjectController@ajax_projects']);
    Route::resource('projects', 'ProjectController', ['as' => 'admin']);
    Route::get('get_employee_data/{id}',['as' => 'admin.projects.employee','uses' =>  'ProjectController@get_employee_data']);
    Route::post('project_status/{id}',['as' => 'admin.projects.project_status','uses' =>  'ProjectController@project_status']);
    Route::get('status_check/{id}',['as' => 'admin.projects.status_check','uses' =>  'ProjectController@status_check']);
    Route::post('update_project_data',['as' => 'admin.projects_update','uses' =>  'ProjectController@update_project_detail']);
    //project employee routes

    Route::get('ajax_project_employees/', ['as' => 'admin.ajax_project_employees', 'uses' => 'ProjectEmployeeController@ajax_project_employees']);
    Route::resource('project_employees', 'ProjectEmployeeController', ['except' => ['show'], 'as' => 'admin']);
    Route::post('update_employee_data',['as' => 'admin.project_employees.update','uses' =>  'ProjectEmployeeController@update_emp_detail']);


    //Project allocation
   Route::get('ajax_project_allocation/', ['as' => 'admin.ajax_project_allocation', 'uses' => 'ProjectAllocationController@ajax_project_allocation']);
    //Route::resource('project_allocation', 'ProjectAllocationController', ['except' => ['show'], 'as' => 'admin']);

   // project allocation filter
    Route::post('project_allocation/filter', ['as' => 'admin.project_allocation.filter', 'uses' => 'ProjectAllocationController@filterEmployee']);
    Route::get('project_allocation-employee', ['as' => 'admin.project_allocation.employee', 'uses' => 'ProjectAllocationController@projectEmployee']);
    Route::resource('project_allocation', 'ProjectAllocationController', ['as' => 'admin']);

    //employee tasks admin
    Route::post('employee_tasks/filter', ['as' => 'admin.employee_tasks.filter', 'uses' => 'EmployeeTasksController@filterTask']);
    Route::get('ajax_employee_tasks/', ['as' => 'admin.ajax_employee_tasks', 'uses' => 'EmployeeTasksController@ajax_employee_tasks']);
    Route::resource('employee_tasks', 'EmployeeTasksController', ['as' => 'admin']);
    ...
    Route::post('profile-settings-update', ['as' => 'admin.profile_settings.update_login', 'uses' => 'ProfileSettingsController@update_login']);
