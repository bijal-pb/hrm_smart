...
as a'), "a.employee_id", "=", "employees.id")
    ...
    public function ajaxApplications()
    {
        ...
        return \DataTables::of($result)->editColumn('start_date', function ($row) {
            return date('Y-m-d', strtotime($row->start_date)) . (isset($row->end_date) ? "<br>to<br>" . date('Y-m-d', strtotime($row->end_date)) : '');
            ...
            ->addColumn('edit', function ($row) {
                ...
                return '<button class="btn btn-outline-success btn-icon waves-effect waves-themed"  onclick="show_application(' . $row->id . ');return false;" ><i class="fal fa-eye"></i></button>';
            })
