    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        <i class="fal fa-trophy"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ trans('core.awardDetails') }}
                    </h2>
                        ...
                        <div class="form-body">
                            <form id="profileForm">
                                <div class="form-group">
                                    ...
                                    <label class="form-label">{{ trans('core.award_name') }} {!! help_text('award_name') !!}
                                        <span class="required">
                                            * </span>
                                    </label>
                                ...
                                <div class="form-group">
                                    <label class="form-label">{{ trans('core.gift') }} {!! help_text('awardGift') !!} <span
                                            class="required">
                                            * </span>
                                    </label>
                                ...
                                <div class="form-group">
                                    <label class="form-label">{{ trans('core.cash_price') }}
                                ...
                                <div class="form-group">
                                    <label class="form-label">{{ trans('core.employee') }}
                                ...
                                <div class="form-group">
                                    <label class="form-label">@lang("core.month"):</label>
                                ...
                                <div class="form-group">
                                    <label class="form-label">{{ trans('core.year') }}:</label>
