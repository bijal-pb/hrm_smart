    ...
    public function ajax_company()
    {
        ...
        return DataTables::of($result)
            ...
            ->addColumn('edit', function ($row) {
                ...
                $string = '<a class="btn btn-primary btn-sm margin-bottom-10" onclick="loadView(\'' . route("admin.companies.edit", $row->id) . '\');"  ><i class="fal fa-edit"></i></a>
                         <a href="javascript:;" onclick="del(' . $row->id . ');return false;" class="btn btn-danger btn-sm margin-bottom-10">
                         ...
                         <i class="fa fa-' . $icon . '"></i> ' . $r_status . '</a><br>';
                if(module_enabled('Subdomain')) {
