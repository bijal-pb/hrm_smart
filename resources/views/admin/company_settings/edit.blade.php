        ...
        <div class="col-md-12">
            ...
            <div id="load">
                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-hdr">
                        <h2><i class="fal  fa-cog"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;@lang('General setting')</h2>
                     ...
                     <div class="panel-container show">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="form-label">{{trans('core.companyName')}}: <span class="text-danger">*</span>
                            </label>
                            <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label class="form-label">{{trans('core.companyAddress')}}:
                            </label>
                            <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label class="form-label">Billing Address: {!! help_text("billingAddress") !!}
                            </label>
                            <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="select2me form-control w-100" data-show-subtext="true" name="country">
                        ...
                        <div class="form-group">
                            <label class="form-label">{{trans('core.phone')}}:
                            </label>
                            <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label class="form-label">@lang("core.companyEmail"): <span class="text-danger">*</span>
                            </label>
                            <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label class="form-label">@lang("core.contactPersonName"): <span class="text-danger">*</span></label>
                            ...
                            <label class="form-label">@lang("core.currency")</label>
                            <div class="col-md-12">
                                <select class="select2me form-control w-100" data-show-subtext="true" name="currency">
                        ...
                        <div class="form-group" id="abc">
                            <label class="form-label">@lang("core.language"): </label>
                            <div class="col-md-12">

                                <select class="select2me form-control w-100" name="select_lang">
                        ...
                        <div class="form-group" id="timezone_container">
                            ...
                            <label class="form-label">@lang("core.timezone"): </label>
                            <div class="col-md-12">
                                <select class="select2me form-control w-100" name="timezone"
                        ...
                        <!------------------------- END FORM ----------------------->
                         <div class="col-md-12">
                            <p class="text-center">
                                <button type="button" id="update_submit" onclick="updateSetting({{ $company->id }})" data-loading-text="{{trans('core.btnUpdating')}}..."
