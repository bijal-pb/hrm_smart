...
<head>
    ...
    {!! HTML::style('front_assets/plugins/fullcalendar/fullcalendar.print.css', ['media' => 'print']) !!}
                ...
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="{{ route('dashboard.index') }}">
                            {!! HTML::image($setting->logo_image_url, 'Logo', ['class' => 'logo-default', 'id' => 'logo-header', 'height' => '30px']) !!}
                                ...
                                @if ($setting->leave_feature == 1)
                                    ...
                                    <li class="dropdown {{ isset($leaveActive) ? $leaveActive : '' }}">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="" onclick="leaveModal();return false;">
                                                    {{ __('menu.applyLeave') }}</a></li>
                                            <li><a href="{{ route('leaves.index') }}"> {{ __('menu.myLeave') }}</a>
                                            </li>
                                ...
                                <li class="dropdown @if (isset($salaryActive)) {{ $salaryActive }} @elseif (Route::is("front.expenses.index")) open @endif">
                                    ...
                                    <ul class="dropdown-menu">
                                        @if ($setting->payroll_feature == 1)
                                            <li><a href="{{ route('front.salary') }}">
                                                    {{ __('menu.salarySlip') }}</a>
                                            </li>
                                        @endif
                                        @if ($setting->expense_feature == 1)
                                            <li>
                                                <a href="{{ route('front.expenses.index') }}">
                                                    {{ trans('menu.expenseFront') }}</a>
                                            </li>
                                        @endif
                                    </ul>
                                </li>
                ...
                <div class="col-md-3 md-margin-bottom-40 @if (!isset($homeActive))hidden-sm hidden-xs @endif">
                    ...
                    @if (count($current_month_birthdays) > 0)
                        <div class="panel-heading-v2 overflow-h">
                            <h2 class="heading-xs pull-left"><i class="fa fa-birthday-cake"></i>
                                {{ __('core.birthdays') }}</h2>
                        </div>
                            ...
                            @foreach ($current_month_birthdays as $birthday)
                                <li class="notification">
                                    ...
                                    <div class="overflow-h">
                                        <span><strong>{{ $birthday->full_name }}</strong>
                                            {{ __('core.hasBirthDayOn') }}</span>
