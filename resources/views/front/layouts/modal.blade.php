                ...
                <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                    <span class="mr-2">
                        <span class="rounded-circle profile-image d-block"
                            style="background-image:url('asset_images/img/demo/avatars/avatar-d.png'); background-size: cover;"></span>
                    </span>
                        ...
                        <ul class="m-0">
                            ...
                            <li>
                                <a href="#" id="myapp-1" data-action="theme-update" data-themesave
                                    data-theme="{{ URL::asset('smart_assets/css/themes/cust-theme-1.css') }}"
                            ...
                            <li>
                                <a href="#" id="myapp-2" data-action="theme-update" data-themesave
                                    data-theme="{{ URL::asset('smart_assets/css/themes/cust-theme-2.css') }}"
                            ...
                            <li>
                                <a href="#" id="myapp-3" data-action="theme-update" data-themesave
                                    data-theme="{{ URL::asset('smart_assets/css/themes/cust-theme-3.css') }}"
                            ...
                            <li>
                                <a href="#" id="myapp-4" data-action="theme-update" data-themesave
                                    data-theme="{{ URL::asset('smart_assets/css/themes/cust-theme-4.css') }}"
                            ...
                            <li>
                                <a href="#" id="myapp-5" data-action="theme-update" data-themesave
                                    data-theme="{{ URL::asset('smart_assets/css/themes/cust-theme-5.css') }}"
                            ...
                            <li>
                                <a href="#" id="myapp-6" data-action="theme-update" data-themesave
                                    data-theme="{{ URL::asset('smart_assets/css/themes/cust-theme-6.css') }}"
                            ...
                            <li>
                                <a href="#" id="myapp-7" data-action="theme-update" data-themesave
                                    data-theme="{{ URL::asset('smart_assets/css/themes/cust-theme-7.css') }}"
                            ...
                            <li>
                                <a href="#" id="myapp-8" data-action="theme-update" data-themesave
                                    data-theme="{{ URL::asset('smart_assets/css/themes/cust-theme-8.css') }}"
                            ...
                            <li>
                                <a href="#" id="myapp-9" data-action="theme-update" data-themesave
                                    data-theme="{{ URL::asset('smart_assets/css/themes/cust-theme-9.css') }}"
                            ...
                            <li>
                                <a href="#" id="myapp-10" data-action="theme-update" data-themesave
                                    data-theme="{{ URL::asset('smart_assets/css/themes/cust-theme-10.css') }}"
                            ...
                            <li>
                                <a href="#" id="myapp-11" data-action="theme-update" data-themesave
                                    data-theme="{{ URL::asset('smart_assets/css/themes/cust-theme-11.css') }}"
                            ...
                            <li>
                                <a href="#" id="myapp-12" data-action="theme-update" data-themesave
                                    data-theme="{{ URL::asset('smart_assets/css/themes/cust-theme-12.css') }}"
                            ...
                            <li>
                                <a href="#" id="myapp-13" data-action="theme-update" data-themesave
                                    data-theme="{{ URL::asset('smart_assets/css/themes/cust-theme-13.css') }}"
                            ...
                            <li>
                                <a href="#" id="myapp-14" data-action="theme-update" data-themesave
                                    data-theme="{{ URL::asset('smart_assets/css/themes/cust-theme-14.css') }}"
                            ...
                            <li>
                                <a href="#" id="myapp-15" data-action="theme-update" data-themesave
                                    data-theme="{{ URL::asset('smart_assets/css/themes/cust-theme-15.css') }}"
                        ...
                        <div class="d-table-cell align-middle">
                            <h5 class="p-0 pr-2 d-flex">
                                ...
                                <a href="#" class="ml-auto fw-400 fs-xs" data-toggle="popover" data-trigger="focus"
                                    ...
                                    data-original-title="<span class='text-primary'>"
                                    data-template="<div class=&quot;popover bg-white border-white&quot; role=&quot;tooltip&quot;><div class=&quot;arrow&quot;></div><h3 class=&quot;popover-header bg-transparent&quot;></h3><div class=&quot;popover-body fs-xs&quot;></div></div>"></a>
                            </h5>
                        </div>
                    </div>
...
<footer class="page-footer" role="contentinfo">
    <div class="d-flex align-items-center flex-1 text-muted">
        <span class="hidden-md-down fw-700">{{ now()->year }} © HRM</span>
    </div>
    {{-- <div>
...
<div class="modal fade apply_modal in" id="applyLeave" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content" id="apply_leave_content">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="d-block position-absolute pos-top pos-right p-2">
...
<div class="modal fade profile_detail_model in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
 aria-hidden="true">
 <div class="modal-dialog">
     <div class="modal-content">
         <div class="modal-header">
         ...
         <div class="modal-body" id="profile_model_body">
             {{-- Load with Ajax call --}}
