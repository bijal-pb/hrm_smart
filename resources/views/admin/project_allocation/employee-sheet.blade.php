...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
             ...
             <div class="panel-hdr">
                        <h2><i class="fal fa-file-spreadsheet"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        Project Allocation<span class="fw-300"><i></i></span>
                        </h2>
                 ...
                 <br>
                    {{-- <div class="btn-theme-panel">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="{{ route('admin.attendances.index') }}" class="btn {{ isset($viewAttendanceActive) ? $viewAttendanceActive : ''}}">
                            <i class="fal fa-th"></i>
                        </a>
                    ...
                    <div class="row filter-row">
                        ...
                        <div class="col-sm-3 col-xs-6">
                            <div class="form-group form-focus">
                                ...
                                <select class="form-control select2 floating" name="month">
                                    <option value="1"
                        ...
                        <div class="col-sm-3 col-xs-6">
                            <div class="form-group form-focus">
                                ...
                                <a href="#" class="btn btn-success btn-block" onclick="filter(); return false;"> Search </a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="panel-container show">
                            <div class="panel-content" > 
                            <div class="table-responsive" id="employee-sheet">
                            </div>
                        </div>
                        </div>
                        </div>
...
@section('page_js')
    ...
    <script type="text/javascript">
       var filter = () => {
            ...
            var url = "{{ route('admin.project_allocation.filter') }}";
            $.easyAjax({
                type: 'POST',
                url: url,
                container: '#employee-sheet',
                data: data,
                success: function (res) {
                    if (res.status === 'success') {
                        $('#employee-sheet').html(res.data);
                    }
                }
            });
        };
