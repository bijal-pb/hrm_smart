...
@section('content')
    ...
    <div class="page-head">
        ...
        <i class="fal fa-rupee-sign"></i>  @lang("pages.payroll.createTitle")
            </h1></div>
    </div>
    <div class="page-bar">
        ...
        <div class="col-md-12">
            ...
            {{--END ERROR MESSAGE BOX--}}
             ...
             <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                    <i class="fal fa-rupee-sign"></i> {{ trans("core.employeeInfo") }}
                   ...
                   <div class="panel-content" >  
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="col-md-9">
                                    <select class="select2me form-control" name="month" id="month">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" data-dismiss="modal" class="btn green" id="show"><i
                                class="fal fa-edit"></i> @lang("core.btnModify")</button>
                </div>
            </div>
        </div>
    </div>
...
@section('page_js')
    ...
    <script>
        ...
        function submitData() {
            $('#add_submit').html('<span class="spinner-grow spinner-grow-sm" role="status" aria-hidden="true"></span>Loading...').attr('disabled', true);
        $.easyAjax({
        ...
        $('#add_submit').html('Submit').attr('disabled', false);
        }
        ...
        function InitializeAdd() {
            ...
            $('#plusButtonD').click(function () {
                ...
                $('<div class="form-group" id="deduction' + j + '">' +
                    ...
                    '</div>' +
                    '<label class="control-label col-md-1">{{$loggedAdmin->company->currency}}</label> ' +
                    '<div class="col-md-2"> <button type="button" onclick="$(\'#deduction' + j + '\').remove();" class="btn btn-danger btn-sm delete">' +
                    '<i class="fal fa-close"></i>' +
                    '</button></div>' +
                    '</div>'+
